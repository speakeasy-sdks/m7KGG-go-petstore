...
package m7kgggopetstore

import (
	"fmt"
	"github.com/speakeasy-sdks/m7KGG-go-petstore/internal/hooks"
	"github.com/speakeasy-sdks/m7KGG-go-petstore/pkg/utils"
	"net/http"
	"time"
)
...
func New(opts ...SDKOption) *Petstore {
	sdk := &Petstore{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.7.1",
			GenVersion:        "2.263.3",
			UserAgent:         "speakeasy-sdk/go 0.7.1 2.263.3 1.0.0 github.com/speakeasy-sdks/m7KGG-go-petstore",
			Hooks:             hooks.New(),
		},
	}
